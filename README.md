...
- обогащать username-таргеты публичными персональными данными без логинов: GitHub account API (name, bio, location, public email, created_at, repos/followers), Mastodon `accounts/lookup` на инстансе аккаунта (display name, счётчики, created_at), Bluesky public AppView (handle, displayName, description, счётчики);
