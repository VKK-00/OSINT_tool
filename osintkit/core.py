...
def transliterate(text: str) -> list[str]:
    ...
    Single implementation lives in osint_toolkit.translit; this re-export
    keeps the legacy osintkit API stable.
    """
    from osint_toolkit.translit import transliterate as _transliterate
